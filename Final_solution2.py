...
# 1st line of code has been changed from the 2nd user
# 2nd line of code has been changed from the 2nd user
...
print("This is the version 2 of the final solution")
